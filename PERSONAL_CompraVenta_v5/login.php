                                                ...
                                                <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner text-center text-white-50 pb-5">
                                                        <div class="carousel-item active">
                                                            <p class="fs-15 fst-italic">" Controlar el inventario es controlar el éxito. ¡Bienvenido a un nuevo día de eficiencia! "</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" El orden no es casualidad, es resultado de tu compromiso diario. "</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" Organización es poder. Bienvenido al control inteligente de tus productos. "</p>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Acceder al software compra y centa de J&K</p>
                                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                <script>document.write(new Date().getFullYear())</script> j&k store. made <i class="mdi mdi-heart text-danger"></i> by brad
                            </p>
                        </div>
                    </div>
                </div>
